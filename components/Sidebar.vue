<template>
  <aside class="flex items-center justify-start w-full h-screen p-0 space-x-6 z-0 absolute scroll-pl-6 snap-x">
    <div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
      <a class="flex items-center justify-center mt-3" href="#">
        <svg class="w-8 h-8 fill-current text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
